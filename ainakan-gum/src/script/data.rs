...
/* glib exports are aliased in ainakan devkit for Linux and Android */
#[cfg(any(target_os = "linux", target_os = "android", target_os = "freebsd"))]
use ainakan_gum_sys::_ainakan_g_bytes_get_data as g_bytes_get_data;

#[cfg(not(any(target_os = "linux", target_os = "android", target_os = "freebsd")))]
use ainakan_gum_sys::g_bytes_get_data;
