use {
    ...
    ainakan_gum_sys::{GMainContext, GMainLoop},
};

#[cfg(any(target_os = "linux", target_os = "android", target_os = "freebsd"))]
use ainakan_gum_sys::{
    _ainakan_g_main_context_iteration as g_main_context_iteration,
    _ainakan_g_main_context_pending as g_main_context_pending,
    _ainakan_g_main_context_push_thread_default as g_main_context_push_thread_default,
    _ainakan_g_main_loop_new as g_main_loop_new,
};
