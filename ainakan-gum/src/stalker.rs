...
//! Code tracing engine.
//!
//! More details about the Ainakan Stalker can be found on the [Stalker page](https://ainakan.re/docs/stalker/)
//! of the Ainakan documentation.
//!
...
//! ```
//! # use ainakan_gum::Gum;
//! # use ainakan_gum::stalker::{Stalker, Transformer};
//! #[cfg(feature = "event-sink")]
//! use ainakan_gum::stalker::NoneEventSink;
...
pub struct Stalker {
    stalker: *mut ainakan_gum_sys::GumStalker,
    _gum: Gum,
}
...
impl Stalker {
    ...
    pub fn is_supported(_gum: &Gum) -> bool {
        unsafe { ainakan_gum_sys::gum_stalker_is_supported() != 0 }
    }
    ...
    pub fn new(gum: &Gum) -> Stalker {
        ...
        Stalker {
            stalker: unsafe { ainakan_gum_sys::gum_stalker_new() },
            _gum: gum.clone(),
        }
    }

    /// Create a new Stalker object from existing raw stalker pointer.
    pub fn from_raw(gum: &Gum, raw_stalker: *mut ainakan_gum_sys::GumStalker) -> Stalker {
        Stalker {
            stalker: raw_stalker,
            _gum: gum.clone(),
        }
    ...
    pub fn new_with_params(gum: &Gum, ic_entries: u32) -> Stalker {
        ...
        Stalker {
            stalker: unsafe { ainakan_gum_sys::gum_stalker_new_with_params(ic_entries) },
            _gum: gum.clone(),
        }
    }
    ...
    pub fn new_with_params(gum: &Gum, ic_entries: u32, adjacent_blocks: u32) -> Stalker {
        ...
        Stalker {
            stalker: unsafe {
                ainakan_gum_sys::gum_stalker_new_with_params(ic_entries, adjacent_blocks)
            },
            _gum: gum.clone(),
        }
    }

    /// Get the underlying ainakan stalker object
    pub fn raw_stalker(&self) -> *mut ainakan_gum_sys::GumStalker {
        self.stalker
    }
    ...
    pub fn follow<S: EventSink>(
        ...
        use ainakan_gum_sys::GumThreadId;
