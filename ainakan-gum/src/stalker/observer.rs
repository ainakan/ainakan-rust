...
use {core::ffi::c_void, ainakan_gum_sys as gum_sys};
...
pub(crate) fn stalker_observer_transform<S: StalkerObserver>(
...
) -> *mut ainakan_gum_sys::GumStalkerObserver {
    let rust = ainakan_gum_sys::RustStalkerObserverVTable {
    ...
    unsafe { ainakan_gum_sys::gum_rust_stalker_observer_new(rust) }
}
