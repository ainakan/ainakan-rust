...
pub struct StalkerIterator<'a> {
    iterator: *mut ainakan_gum_sys::GumStalkerIterator,
    phantom: PhantomData<&'a ainakan_gum_sys::GumStalkerIterator>,
}

extern "C" fn put_callout_callback(
    cpu_context: *mut ainakan_gum_sys::GumCpuContext,
...
impl<'a> StalkerIterator<'a> {
    fn from_raw(iterator: *mut ainakan_gum_sys::GumStalkerIterator) -> StalkerIterator<'a> {
        StalkerIterator {
            iterator,
            phantom: PhantomData,
        }
    ...
    pub fn keep_instr(&self) {
        unsafe { ainakan_gum_sys::gum_stalker_iterator_keep(self.iterator) };
    }
    ...
    pub fn put_callout(&self, callout: impl FnMut(CpuContext)) {
        unsafe {
            ...
            ainakan_gum_sys::gum_stalker_iterator_put_callout(
                self.iterator,
    ...
    pub fn put_chaining_return(&self) {
        unsafe { ainakan_gum_sys::gum_stalker_iterator_put_chaining_return(self.iterator) };
    }
}

use ainakan_gum_sys::cs_insn;

pub struct Instruction<'a> {
    parent: *mut ainakan_gum_sys::GumStalkerIterator,
    instr: Insn,
...
impl<'a> Instruction<'a> {
    ...
    pub fn keep(&self) {
        unsafe { ainakan_gum_sys::gum_stalker_iterator_keep(self.parent) };
    }
    ...
    pub fn put_chaining_return(&self) {
        unsafe { ainakan_gum_sys::gum_stalker_iterator_put_chaining_return(self.parent) };
    }
...
impl<'a> Iterator for StalkerIterator<'a> {
    ...
    fn next(&mut self) -> Option<Instruction<'a>> {
        ...
        if unsafe { ainakan_gum_sys::gum_stalker_iterator_next(self.iterator, &mut instr as *mut _) }
            != 0
        {
...
pub struct StalkerOutput<'a> {
    pub output: *mut ainakan_gum_sys::GumStalkerOutput,
    phantom: PhantomData<&'a ainakan_gum_sys::GumStalkerOutput>,
}

impl<'a> StalkerOutput<'a> {
    fn from_raw(output: *mut ainakan_gum_sys::GumStalkerOutput) -> StalkerOutput<'a> {
        StalkerOutput {
            output,
            phantom: PhantomData,
        }
...
extern "C" fn transformer_callback(
    iterator: *mut ainakan_gum_sys::GumStalkerIterator,
    output: *mut ainakan_gum_sys::GumStalkerOutput,
    user_data: *mut c_void,
) {
    let mut f =
...
pub struct Transformer<'a> {
    pub(crate) transformer: *mut ainakan_gum_sys::GumStalkerTransformer,
    phantom: PhantomData<&'a ainakan_gum_sys::GumStalkerTransformer>,
}
...
impl<'a> Transformer<'a> {
        ...
        'b: 'a,
    {
        ...
        Transformer {
            transformer: unsafe {
                ainakan_gum_sys::gum_stalker_transformer_make_from_callback(
...
impl Drop for Transformer<'_> {
    fn drop(&mut self) {
        unsafe { ainakan_gum_sys::g_object_unref(self.transformer as *mut c_void) }
    }
}
