...
//! development kits on the [Ainakan releases page](https://github.com/ainakan/ainakan/releases).
...
//! ```
//! use ainakan_gum::{Gum, stalker::{Stalker, Transformer}};
...
impl Drop for GumSingleton {
    fn drop(&mut self) {
        unsafe { ainakan_gum_sys::gum_deinit_embedded() };
    }
}

impl GumSingleton {
    fn obtain() -> Self {
        unsafe { ainakan_gum_sys::gum_init_embedded() };
        Self
    }
}
